...
# ===== 选择内核版本 =====
echo "============================================================"
echo "    OPPO / OnePlus / realme SM8750 / MT6991 内核统一编译脚本"
echo "============================================================"
echo "  1) SM8750  6.6.30   - OnePlus 13"
echo "  2) MT6991  6.6.50   - Ace 5 Ultra"
echo "  3) SM8750  6.6.56   - OnePlus 13T"
echo "  4) SM8750  6.6.57   - Pad 2 Pro"
echo "  5) SM8750  6.6.66   - OnePlus 13"
echo "  6) SM8750  6.6.89   - OnePlus 13 / ColorOS 16"
echo "  7) MT6991  6.6.89   - Ace 5 Ultra"
echo "  8) SM8750  6.6.118  - OnePlus 13 / ColorOS 16"
echo "============================================================"
read -p "请选择编译版本 [1-8，默认：6]: " KERNEL_CHOICE
KERNEL_CHOICE=${KERNEL_CHOICE:-6}

case "$KERNEL_CHOICE" in
  1)
    KERNEL_VERSION="6.6.30"
    KERNEL_PLATFORM="SM8750"
    KERNEL_BRANCH="oneplus/sm8750_v_15.0.0_oneplus_13"
    KERNEL_REPO="https://github.com/HeiKe-Tom/android_kernel_common_oneplus_sm8750"
    ;;
  2)
    KERNEL_VERSION="6.6.50"
    KERNEL_PLATFORM="MT6991"
    KERNEL_BRANCH="oneplus/mt6991_v_15.0.2_ace5_ultra"
    KERNEL_REPO="https://github.com/HeiKe-Tom/android_kernel_oneplus_mt6991"
    ;;
  3)
    KERNEL_VERSION="6.6.56"
    KERNEL_PLATFORM="SM8750"
    KERNEL_BRANCH="oneplus/sm8750_v_15.0.2_oneplus_13t"
    KERNEL_REPO="https://github.com/HeiKe-Tom/android_kernel_common_oneplus_sm8750"
    ;;
  4)
    KERNEL_VERSION="6.6.57"
    KERNEL_PLATFORM="SM8750"
    KERNEL_BRANCH="oneplus/sm8750_v_15.0.1_pad_2_pro"
    KERNEL_REPO="https://github.com/HeiKe-Tom/android_kernel_common_oneplus_sm8750"
    ;;
  5)
    KERNEL_VERSION="6.6.66"
    KERNEL_PLATFORM="SM8750"
    KERNEL_BRANCH="oneplus/sm8750_v_15.0.2_oneplus_13_6.6.66"
    KERNEL_REPO="https://github.com/HeiKe-Tom/android_kernel_common_oneplus_sm8750"
    ;;
  6)
    KERNEL_VERSION="6.6.89"
    KERNEL_PLATFORM="SM8750"
    KERNEL_BRANCH="oneplus/sm8750_v_16.0.0_oneplus_13_6.6.89"
    KERNEL_REPO="https://github.com/HeiKe-Tom/android_kernel_common_oneplus_sm8750"
    ;;
  7)
    KERNEL_VERSION="6.6.89"
    KERNEL_PLATFORM="MT6991"
    KERNEL_BRANCH="oneplus/mt6991_v_15.0.2_ace5_ultra_6.6.89"
    KERNEL_REPO="https://github.com/HeiKe-Tom/android_kernel_oneplus_mt6991"
    ;;
  8)
    KERNEL_VERSION="6.6.118"
    KERNEL_PLATFORM="SM8750"
    KERNEL_BRANCH="oneplus/sm8750_v_16.0.0_oneplus_13_6.6.118"
    KERNEL_REPO="https://github.com/HeiKe-Tom/android_kernel_common_oneplus_sm8750"
    ;;
  *)
    echo "错误：无效的版本选择。"
...
echo ">>> 已选择：$KERNEL_PLATFORM / Linux $KERNEL_VERSION"
echo ">>> 仓库：$KERNEL_REPO"
echo ">>> 分支：$KERNEL_BRANCH"
echo

# MT6991 原脚本默认关闭网络增强；SM8750 原脚本默认开启。
if [[ "$KERNEL_PLATFORM" == "MT6991" ]]; then
  BETTERNET_DEFAULT="n"
else
  BETTERNET_DEFAULT="y"
fi
...
# ===== 设置自定义参数 =====
echo "===== 欧加真${KERNEL_PLATFORM}通用${KERNEL_VERSION} A15/A16 OKI内核本地编译脚本 By Coolapk@TomHjy ====="
echo ">>> 读取用户配置..."
...
read -p "是否启用网络功能增强优化配置？(y/n，默认：$BETTERNET_DEFAULT): " APPLY_BETTERNET
APPLY_BETTERNET=${APPLY_BETTERNET:-$BETTERNET_DEFAULT}
...
if [[ $KSU_BRANCH == [yYrR] ]]; then
  ...
  echo 'CONFIG_KSU_FULL_NAME_FORMAT="%TAG_NAME%-%COMMIT_SHA%@HeiKe-Tom"' >> ./common/arch/arm64/configs/gki_defconfig
elif [[ "$KSU_BRANCH" == "n" || "$KSU_BRANCH" == "N" ]]; then
...
if [[ "$APPLY_SUSFS" == [yY] ]]; then
  echo ">>> 克隆补丁仓库..."
  git clone --depth=1 https://github.com/HeiKe-Tom/susfs4oki.git susfs4ksu -b oki-android15-6.6
...
if [[ "$APPLY_LZ4" == "y" || "$APPLY_LZ4" == "Y" ]]; then
  ...
  git clone --depth=1 https://github.com/HeiKe-Tom/oppo_oplus_realme_sm8750.git
...
cd common
wget https://github.com/HeiKe-Tom/oppo_oplus_realme_sm8750/raw/refs/heads/main/other_patch/cve-2026-43499-rtmutex-6.6.patch
...
if [[ "$APPLY_BETTERNET" == "y" || "$APPLY_BETTERNET" == "Y" ]]; then
  ...
  cd common
  wget https://github.com/HeiKe-Tom/oppo_oplus_realme_sm8750/raw/refs/heads/main/other_patch/config.patch
...
if [[ "$APPLY_DROIDSPACES" == [sSeE] ]]; then
  ...
  wget https://github.com/HeiKe-Tom/oppo_oplus_realme_sm8750/raw/refs/heads/main/droidspaces_patch/fix_sysvipc_kabi_6_7_8.patch
  patch -p1 -F 3 < fix_sysvipc_kabi_6_7_8.patch || true
  # 修补 oplus_bsp_midas 行为，避免开机崩溃
  wget https://github.com/HeiKe-Tom/oppo_oplus_realme_sm8750/raw/refs/heads/main/droidspaces_patch/fix_oplus_bsp_midas.patch
  patch -p1 -F 3 < fix_oplus_bsp_midas.patch || true
  # 应用 NTSync 补丁
  wget https://github.com/HeiKe-Tom/oppo_oplus_realme_sm8750/raw/refs/heads/main/droidspaces_patch/ntsync_base.patch
  wget https://github.com/HeiKe-Tom/oppo_oplus_realme_sm8750/raw/refs/heads/main/droidspaces_patch/ntsync_compat_android15-6.6.patch
  ...
  if [[ "$APPLY_DROIDSPACES" == [eE] ]]; then
    ...
    cd common
    wget https://github.com/HeiKe-Tom/oppo_oplus_realme_sm8750/raw/refs/heads/main/droidspaces_patch/evdi_drm.patch
...
if [[ "$APPLY_BBG" == "y" || "$APPLY_BBG" == "Y" ]]; then
  ...
  cd ./common
  curl -sSL https://github.com/HeiKe-Tom/Baseband-guard/raw/master/setup.sh | bash
...
git clone https://github.com/HeiKe-Tom/AnyKernel3 --depth=1
...
if [[ "$APPLY_LZ4KD" == "y" || "$APPLY_LZ4KD" == "Y" ]]; then
  wget https://raw.githubusercontent.com/HeiKe-Tom/oppo_oplus_realme_sm8750/refs/heads/main/zram.zip
fi
